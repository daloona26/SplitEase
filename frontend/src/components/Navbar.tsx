    ...
    <nav className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-lg border-b border-white/20 dark:border-slate-700/50 sticky top-0 z-50 transition-all duration-300">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          ...
          ></div>
          {/* Mobile Menu Panel */}
          <div className="fixed top-0 right-0 w-2/3 max-w-sm h-full bg-white dark:bg-slate-800 shadow-lg p-6 z-50 transform translate-x-0 transition-transform duration-300 ease-out">
            ...
            <div className="flex flex-col space-y-3">
              {user ? (
                <>
                  <Link
                    to="/dashboard"
                    className="flex items-center space-x-2 px-3 py-2 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/50 rounded-md font-medium text-base"
                    onClick={closeMobileMenu}
                  >
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center space-x-2 px-3 py-2 text-slate-700 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/50 rounded-md font-medium text-base"
                  >
                ...
                <>
                  <Link
                    to="/login"
                    className="px-3 py-2 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium rounded-md hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-all duration-200 text-base"
                    onClick={closeMobileMenu}
                  >
                    Login
                  </Link>
